...
function checkForShelter(str) {
        var shelterAddresses = /^117 CARRIER|^1165 HERMITAGE|^25 SHELDON|^72 SHELDON|^40 JEFFERSON|^110 HALL|^1115 BALL|^144 DIVISION|^144 S DIVISION|^200 EASTERN|^220 EASTERN|^225 COMMERCE|^255 DIVISION|^255 S DIVISION|^320 STATE|^322 FRONT|^343 DIVISION|^343 S DIVISION|^523 LYON|^324 LYON|^701 PROSPECT|^710 FULTON|^710 W FULTON|^750 CHERRY|^761 BRIDGE|^766 7TH|^766 SEVENTH|^801 COLLEGE|^822 CHERRY|^901 EASTERN|^904 SHELDON|^906 DIVISION|^906 S DIVISION|^920 CHERRY|^938 HUMBOLT|^1024 IONIA|^1025 LAFAYETTE|^1215 FULTON|^1215 E FULTON|^1491 DIVISION|^2355 KNAPP|^2440 RICHMOND|^54 DIVISION|^54 S DIVISION|^1706 DIVISION|^1706 S DIVISION|^1366 ELLIOT/i;
