...
/* to override these locally (with remote xul), create a server/skin/custom.js file containing lines like
    ...
    urls['AUDIO_good'] = '/xul/grpl_28/server/skin/media/custom/good.wav';
...
const CLIENT_VERSION = 'grpl_28';
const CLIENT_STAMP   = 'grpl_28';
...
var urls = {
    ...
    'AUDIO_good' : '/xul/grpl_28/server/skin/media/audio/bonus.wav',
    'AUDIO_bad' : '/xul/grpl_28/server/skin/media/audio/question.wav',
    'AUDIO_horrible' : '/xul/grpl_28/server/skin/media/audio/redalert.wav',
    'AUDIO_circ_good' : '/xul/grpl_28/server/skin/media/audio/toggled.wav',
    'AUDIO_circ_bad' : '/xul/grpl_28/server/skin/media/audio/question.wav',
    'AUDIO_event_ASSET_COPY_NOT_FOUND' : '/xul/grpl_28/server/skin/media/audio/redalert.wav',

    'AUTHORITY_MANAGE' : 'cat/authority/list',
    'MANAGE_MULTI_HOME_ITEMS' : 'oils://remote/xul/grpl_28/server/cat/manage_multi_home_items.xul',
    'XUL_AUTH_SIMPLE' : 'oils://remote/xul/grpl_28/server/main/simple_auth.xul',
    'XUL_BIB_BRIEF' : 'oils://remote/xul/grpl_28/server/cat/bib_brief.xul',
    'XUL_BIB_BRIEF_VERTICAL' : 'oils://remote/xul/grpl_28/server/cat/bib_brief_vertical.xul',
    'XUL_BROWSER' : 'chrome://open_ils_staff_client/content/util/browser.xul',
    'XUL_CHECKIN' : 'oils://remote/xul/grpl_28/server/circ/checkin.xul',
    'XUL_BACKDATE' : 'oils://remote/xul/grpl_28/server/circ/backdate_post_checkin.xul',
    'XUL_RENEW' : 'oils://remote/xul/grpl_28/server/circ/renew.xul',
    'XUL_CHECKOUT' : 'oils://remote/xul/grpl_28/server/circ/checkout.xul',
    'XUL_CIRC_BRIEF' : 'oils://remote/xul/grpl_28/server/circ/circ_brief.xul',
    'XUL_CIRC_SUMMARY' : 'oils://remote/xul/grpl_28/server/circ/circ_summary.xul',
    'XUL_COPY_BUCKETS_QUICK' : 'oils://remote/xul/grpl_28/server/cat/copy_buckets_quick.xul',
    'XUL_COPY_BUCKETS' : 'oils://remote/xul/grpl_28/server/cat/copy_buckets.xul',
    'XUL_COPY_DETAILS' : 'oils://remote/xul/grpl_28/server/circ/copy_details.xul',
    'XUL_COPY_EDITOR' : 'oils://remote/xul/grpl_28/server/cat/copy_editor.xul',
    'XUL_COPY_LOCATION_EDIT' : 'oils://remote/xul/grpl_28/server/admin/copy_locations.xhtml',
    'XUL_COPY_NOTES' : 'oils://remote/xul/grpl_28/server/cat/copy_notes.xul',
    'XUL_COPY_STATUS' : 'oils://remote/xul/grpl_28/server/circ/copy_status.xul',
    'XUL_COPY_SUMMARY' : 'oils://remote/xul/grpl_28/server/cat/copy_summary.xul',
    'XUL_COPY_VOLUME_BROWSE' : 'oils://remote/xul/grpl_28/server/cat/copy_browser.xul',
    'XUL_DEBUG_CONSOLE' : 'chrome://global/content/console.xul',
    'XUL_DEBUG_FIELDMAPPER' : 'oils://remote/xul/grpl_28/server/util/fm_view.xul',
    'XUL_DEBUG_FILTER_CONSOLE' : 'oils://remote/xul/grpl_28/server/util/filter_console.xul',
    'XUL_DEBUG_SHELL' : 'oils://remote/xul/grpl_28/server/util/shell.html',
    'XUL_DEBUG_XULEDITOR' : 'oils://remote/xul/grpl_28/server/util/xuledit.xul',
    'XUL_DO_NOT_AUTO_ATTEMPT_PRINT_SETTING' : 'oils://remote/xul/grpl_28/server/admin/do_not_auto_attempt_print_setting.xul',
    'XUL_FANCY_PROMPT' : 'oils://remote/xul/grpl_28/server/util/fancy_prompt.xul',
    'XUL_HOLD_CAPTURE' : 'oils://remote/xul/grpl_28/server/circ/hold_capture.xul',
    /*'XUL_HOLD_PULL_LIST' : 'oils://remote/xul/grpl_28/server/admin/hold_pull_list.xhtml',*/
    'XUL_HOLD_PULL_LIST' : 'oils://remote/xul/grpl_28/server/patron/holds.xul',
    'XUL_HOLDS_BROWSER' : 'oils://remote/xul/grpl_28/server/patron/holds.xul',
    'XUL_HOLD_DETAILS' : 'oils://remote/xul/grpl_28/server/patron/hold_details.xul',
    'XUL_HOLD_CANCEL' : 'oils://remote/xul/grpl_28/server/patron/hold_cancel.xul',
    'XUL_HOLD_PLACEMENT' : 'oils://remote/xul/grpl_28/server/patron/place_hold.xul',
    'XUL_IN_HOUSE_USE' : 'oils://remote/xul/grpl_28/server/circ/in_house_use.xul',
    'XUL_LIST_CLIPBOARD' : 'oils://remote/xul/grpl_28/server/util/list_clipboard.xul',
    'XUL_LOCAL_ADMIN' : 'oils://remote/xul/grpl_28/server/admin/index.xhtml',
    'XUL_LOGIN_DATA' : 'oils://remote/xul/grpl_28/server/main/data.xul',
    'XUL_MARC_NEW' : 'oils://remote/xul/grpl_28/server/cat/marc_new.xul',
    'XUL_MARC_EDIT' : 'oils://remote/xul/grpl_28/server/cat/marcedit.xul',
    'XUL_MARC_VIEW' : 'oils://remote/xul/grpl_28/server/cat/marc_view.xul',
    'XUL_MENU_FRAME' : 'chrome://open_ils_staff_client/content/main/menu_frame.xul',
    'XUL_NON_CAT_LABEL_EDIT' : 'oils://remote/xul/grpl_28/server/admin/non_cat_types.xhtml',
    'XUL_OFFLINE_UPLOAD_XACTS' : 'oils://remote/xul/grpl_28/server/admin/upload_xacts.xhtml',
    'XUL_OFFLINE_MANAGE_XACTS' : 'oils://remote/xul/grpl_28/server/admin/offline_manage_xacts.xul',
    'XUL_OFFLINE_MANAGE_XACTS_CGI' : '/cgi-bin/offline/offline.pl', // Dunno if this needs oils://remote
    'XUL_OFFLINE_GENERATE_WIDGETS' : 'oils://remote/xul/grpl_28/server/main/gen_offline_widgets.xul',
    'XUL_REMOTE_OPAC_WRAPPER' : 'oils://remote/xul/grpl_28/server/cat/opac.xul',
    'XUL_OPAC_WRAPPER' : 'chrome://open_ils_staff_client/content/cat/opac.xul',
    'XUL_PATRON_BARCODE_ENTRY' : 'oils://remote/xul/grpl_28/server/patron/barcode_entry.xul',
    'XUL_PATRON_BILLS' : 'oils://remote/xul/grpl_28/server/patron/bill2.xul',
    'XUL_PATRON_BILL_CC_INFO' : 'oils://remote/xul/grpl_28/server/patron/bill_cc_info.xul',
    'XUL_PATRON_BILL_CHECK_INFO' : 'oils://remote/xul/grpl_28/server/patron/bill_check_info.xul',
    'XUL_PATRON_BILL_DETAILS' : 'oils://remote/xul/grpl_28/server/patron/bill_details.xul',
    'XUL_PATRON_BILL_HISTORY' : 'oils://remote/xul/grpl_28/server/patron/bill_history.xul',
    'XUL_PATRON_BILL_WIZARD' : 'oils://remote/xul/grpl_28/server/patron/bill_wizard.xul',
    'XUL_PATRON_DISPLAY' : 'oils://remote/xul/grpl_28/server/patron/display.xul',
    'XUL_PATRON_HORIZ_DISPLAY' : 'oils://remote/xul/grpl_28/server/patron/display_horiz.xul',
    'XUL_PATRON_EDIT' : 'oils://remote/eg/actor/user/register',
    'XUL_PATRONS_DUE_REFUNDS' : 'oils://remote/xul/grpl_28/server/admin/patrons_due_refunds.xul',
    'XUL_USER_PERM_EDITOR' : 'oils://remote/xul/grpl_28/server/patron/user_edit.xul',
    'XUL_PATRON_HOLDS' : 'oils://remote/xul/grpl_28/server/patron/holds.xul',
    'XUL_PATRON_INFO_NOTES' : 'oils://remote/xul/grpl_28/server/patron/info_notes.xul',
    'XUL_PATRON_INFO_STAT_CATS' : 'oils://remote/xul/grpl_28/server/patron/info_stat_cats.xul',
    'XUL_PATRON_INFO_SURVEYS' : 'oils://remote/xul/grpl_28/server/patron/info_surveys.xul',
    'XUL_PATRON_INFO_GROUP' : 'oils://remote/xul/grpl_28/server/patron/info_group.xul',
    'XUL_PATRON_ITEMS' : 'oils://remote/xul/grpl_28/server/patron/items.xul',
    'XUL_PATRON_SEARCH_FORM' : 'oils://remote/xul/grpl_28/server/patron/search_form.xul',
    'XUL_PATRON_HORIZONTAL_SEARCH_FORM' : 'oils://remote/xul/grpl_28/server/patron/search_form_horiz.xul',
    'XUL_PATRON_SEARCH_RESULT' : 'oils://remote/xul/grpl_28/server/patron/search_result.xul',
    'XUL_PATRON_SUMMARY' : 'oils://remote/xul/grpl_28/server/patron/summary.xul',
    'XUL_PRE_CAT' : 'oils://remote/xul/grpl_28/server/circ/pre_cat_fields.xul',
    'XUL_PRINT_LIST_TEMPLATE_EDITOR' : 'oils://remote/xul/grpl_28/server/circ/print_list_template_editor.xul',
    'XUL_RECORD_BUCKETS' : 'oils://remote/xul/grpl_28/server/cat/record_buckets.xul',
    'XUL_RECORD_BUCKETS_QUICK' : 'oils://remote/xul/grpl_28/server/cat/record_buckets_quick.xul',
    'XUL_REMOTE_BROWSER' : 'oils://remote/xul/grpl_28/server/util/rbrowser.xul',
    'XUL_SERIAL_ITEM_EDITOR' : 'oils://remote/xul/grpl_28/server/serial/sitem_editor.xul',
    'XUL_SERIAL_NOTES' : 'oils://remote/xul/grpl_28/server/serial/notes.xul',
    'XUL_SERIAL_SELECT_AOU' : 'oils://remote/xul/grpl_28/server/serial/select_aou.xul',
    'XUL_SERIAL_SELECT_UNIT' : 'oils://remote/xul/grpl_28/server/serial/select_unit.xul',
    'XUL_SERIAL_SERCTRL_MAIN' : 'oils://remote/xul/grpl_28/server/serial/serctrl_main.xul',
    'XUL_SPINE_LABEL' : 'oils://remote/xul/grpl_28/server/cat/spine_labels.xul',
    'XUL_STAGED_PATRONS' : 'oils://remote/xul/grpl_28/server/patron/staged.xul',
    'XUL_STANDALONE' : 'chrome://open_ils_staff_client/content/circ/offline.xul',
    'XUL_STANDING_PENALTIES' : 'oils://remote/xul/grpl_28/server/patron/standing_penalties.xul',
    'XUL_NEW_STANDING_PENALTY' : 'oils://remote/xul/grpl_28/server/patron/new_standing_penalty.xul',
    'XUL_EDIT_STANDING_PENALTY' : 'oils://remote/xul/grpl_28/server/patron/edit_standing_penalty.xul',
    'XUL_SCAN_ITEM_AS_MISSING_PIECES' : 'oils://remote/xul/grpl_28/server/circ/missing_pieces.xul',
    'XUL_STAT_CAT_EDIT' : 'oils://remote/xul/grpl_28/server/admin/stat_cat_editor.xhtml',
    ...
    'XUL_VOLUME_COPY_CREATOR' : 'oils://remote/xul/grpl_28/server/cat/volume_copy_editor.xul',
    'XUL_VOLUME_COPY_CREATOR_HORIZONTAL' : 'oils://remote/xul/grpl_28/server/cat/volume_copy_editor_horiz.xul',
    'XUL_VOLUME_COPY_CREATOR_ORIGINAL' : 'oils://remote/xul/grpl_28/server/cat/volume_copy_creator.xul',
    'XUL_VOLUME_EDITOR' : 'oils://remote/xul/grpl_28/server/cat/volume_editor.xul',
    'XUL_WORK_LOG' : 'oils://remote/xul/grpl_28/server/admin/work_log.xul',
    'XUL_WORKSTATION_INFO' : 'oils://remote/xul/grpl_28/server/main/ws_info.xul',
    'XUL_Z3950_IMPORT' : 'oils://remote/xul/grpl_28/server/cat/z3950.xul',
    'TEST_HTML' : '/xul/grpl_28/server/main/test.html', // This is html, not xul....does it need oils://remote?
    'TEST_XUL' : 'oils://remote/xul/grpl_28/server/main/test.xul',
    ...
    'XUL_LOCAL_ADMIN_BASE' : 'oils://remote/xul/grpl_28/server/admin',
    ...
    'XUL_SERIAL_BATCH_RECEIVE': 'oils://remote/xul/grpl_28/server/serial/batch_receive.xul',
    'XUL_SERIAL_PATTERN_WIZARD' : 'oils://remote/xul/grpl_28/server/serial/pattern_wizard.xul',
    'EG_MARCEDIT_PHYS_CHAR_WIZARD' : 'oils://remote/eg/cat/marcedit/phys_char_wizard',
    'CUSTOM_JS' : '/xul/grpl_28/server/skin/custom.js',
    ...
    'XUL_SERVER_ADDONS' : 'oils://remote/xul/grpl_28/server/addon/addons.xul'
}
