...
addon.pv_supa_goodstuff.prototype = {
    'common_ui_init' : function() {
        ...
        try {
            ...
            mc.setAttribute(
                'src',
                '/xul/grpl_28/server/locale/'+LOCALE+'/addon/pv_supa_goodstuff.properties'
            );
            ...
            var uri = ios.newURI(
                'oils://remote/xul/grpl_28/server/skin/addon/pv_supa_goodstuff.css',
                null,
                null
            );
    ...
    'prefs_init' : function() {
        ...
        try {
            ...
            var url = '/xul/grpl_28/server/addon/pv_supa_goodstuff_config_overlay.xul';
