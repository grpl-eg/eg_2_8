        function my_init() {
            try {
                ...
                JSAN.addRepository('/xul/grpl_28/server/');
                ...
                try {
                    g.error.standard_unexpected_error_alert('/xul/grpl_28/server/cat/spine_labels.xul',E);
                } catch(F) {
        ...
        function preview(idx) {
            try {
                    ...
                    var html = "<html><head>";
                    html += "<link type='text/css' rel='stylesheet' href='" + xulG.url_prefix('/xul/grpl_28/server/skin/print.css') + "'></link>"
