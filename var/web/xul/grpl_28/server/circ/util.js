...
var float = new Array ('non_floating','branch_float','non_floating');
                ...
                case 8: /* ON HOLDS SHELF */
                    ...
                    if (!auto_print) {
                        rv = error.yns_alert_formatted(
                            ...
                            '/xul/grpl_28/server/skin/media/images/hold.gif'
                        );
                    } else {
...
//hide name if we have an alias
if (print_data.user.alias()){
        print_data.user.family_name('');
        print_data.user.first_given_name('');
}
                                var parms = {
            ...
            if (!auto_print) {
                rv = error.yns_alert_formatted(
                    ...
                    null,
                    document.getElementById('circStrings').getString('staff.circ.confirm.msg'),
                    '/xul/grpl_28/server/skin/media/images/transit.gif'
                );
            } else {
                if (suppress_popups && !no_print_prompting) {
                    // FIXME: add SFX and/or GFX
            ...
            if (!suppress_popups) {
                rv = error.yns_alert_formatted(
                    ...
                    null,
                    document.getElementById('circStrings').getString('staff.circ.confirm.msg'),
                    '/xul/grpl_28/server/skin/media/images/stop_sign.png'
                );
            } else {
                // FIXME: add SFX and/or GFX
                sound.circ_bad();
