...
/* FIXME: serial items print template?			JSAN.use('patron.util');
    ...
    'set_alert_notes_button' : function() {
        ...
        if (num_alerts > 0) {
            ...
            $('serial_alert_button_image').src = '/xul/grpl_28/server/skin/media/images/bell.png';
            if (num_alerts == 1) {
            ...
            $('serial_alert_button_image').src = '/xul/grpl_28/server/skin/media/images/bell_disabled.png';
